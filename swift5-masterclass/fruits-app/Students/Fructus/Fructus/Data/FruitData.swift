...
public let fruitsData: [Fruit] = [
  Fruit(
    title: .init("Blueberry"),
    headline: .init("Blueberries are a sweet, nutritious, and wildly popular fruit all over the world."),
    image: .init("blueberry"),
    gradientColors: .init([Color("ColorBlueberryLight"), Color("ColorBlueberryDark")]),
    description: .init("""
      ...
      """),
    nutritionFacts: [
      .init(.energy, "240 kJ (57 kcal)"),
      .init(.sugar, "9.96 g"),
      .init(.fat, "0.33 g"),
      .init(.protein, "0.74 g"),
      .init(.vitamins, "A, B1, B2, B3, B5, B6, B9, C, E, K"),
      .init(.minerals, "Calcium, Iron, Magnasium, Manganese, Phosphorus, Sodium, Zinc")
    ]
  ),
  Fruit(
    title: .init("Strawberry"),
    headline: .init("Widely appreciated for its characteristic aroma, red color, juicy texture, and sweetness."),
    image: .init("strawberry"),
    gradientColors: .init([Color("ColorStrawberryLight"), Color("ColorStrawberryDark")]),
    description: .init("""
      ...
      """),
    nutritionFacts: [
      .init(.energy, "136 kJ (33 kcal)"),
      .init(.sugar, "4.89 g"),
      .init(.fat, "0.3 g"),
      .init(.protein, "0.67 g"),
      .init(.vitamins, "B1, B2, B3, B5, B6, B9, Choline, C, E, K"),
      .init(.minerals, "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Sodium, Zinc")
    ]
  ),
  Fruit(
    title: .init("Lemon"),
    headline: .init("There's no doubt lemons are delicious, but does adding them to water make you healthier?"),
    image: .init("lemon"),
    gradientColors: .init([Color("ColorLemonLight"), Color("ColorLemonDark")]),
    description: .init("""
      ...
      """),
    nutritionFacts: [
      .init(.energy, "121 kJ (29 kcal)"),
      .init(.sugar, "2.5 g"),
      .init(.fat, "0.3 g"),
      .init(.protein, "1.1 g"),
      .init(.vitamins, "B1, B2, B3, B5, B6, B9, C, Choline"),
      .init(.minerals, "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Zinc")
    ]
  ),
  Fruit(
    title: .init("Plum"),
    headline: .init("Plums are a very nutritious fruit. An excellent source of vitamins, minerals, fiber and antioxidants."),
    image: .init("plum"),
    gradientColors: .init([Color("ColorPlumLight"), Color("ColorPlumDark")]),
    description: .init("""
  ...
  Fruit(
    title: .init("Lime"),
    headline: .init("Sour, round, and bright green citrus fruits. Limes are high in vitamin C, antioxidants, and other nutrients."),
    image: .init("lime"),
    gradientColors: .init([Color("ColorLimeLight"), Color("ColorLimeDark")]),
    description: .init("""
    ...
    """),
    nutritionFacts: [
      .init(.energy, "126 kJ (30 kcal)"),
      .init(.sugar, "1.7 g"),
      .init(.fat, "0.2 g"),
      .init(.protein, "0.7 g"),
      .init(.vitamins, "B1, B2, B3, B5, B6, B9, C"),
      .init(.minerals, "Calcium, Iron, Magnasium, Phosphorus, Potassium, Sodium")
    ]
  ),
  Fruit(
    title: .init("Pomegranate"),
    headline: .init("Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft."),
    image: .init("pomegranate"),
    gradientColors: .init([Color("ColorPomegranateLight"), Color("ColorPomegranateDark")]),
    description: .init("""
      ...
      """),
    nutritionFacts: [
      .init(.energy, "346 kJ (83 kcal)"),
      .init(.sugar, "13.67 g"),
      .init(.fat, "1.17 g"),
      .init(.protein, "1.67 g"),
      .init(.vitamins, "B1, B2, B3, B5, B6, B9, C, E, K"),
      .init(.minerals, "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Sodium, Zinc")
    ]
  ),
  Fruit(
    ...
    headline: .init("Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft."),
    image: .init("pear"),
    gradientColors: .init([Color("ColorPearLight"), Color("ColorPearDark")]),
    description: .init("""
  ...
  Fruit(
    title: .init("Gooseberry"),
    headline: .init("Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft."),
    image: .init("gooseberry"),
    gradientColors: .init([Color("ColorGooseberryLight"), Color("ColorGooseberryDark")]),
    description: .init("""
      ...
      """),
    nutritionFacts: [
      .init(.energy, "184 kJ (44 kcal)"),
      .init(.sugar, "6.15 g"),
      .init(.fat, "0.58 g"),
      .init(.protein, "0.88 g"),
      .init(.vitamins, "A, B1, B2, B3, B5, B6, B9, C, E"),
      .init(.minerals, "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Sodium, Zinc")
    ]
  ),
  Fruit(
    ...
    headline: .init("Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft."),
    image: .init("mango"),
    gradientColors: .init([Color("ColorMangoLight"), Color("ColorMangoDark")]),
    description: .init("""
  ...
  Fruit(
    title: .init("Watermelon"),
    headline: .init("Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft."),
    image: .init("watermelon"),
    gradientColors: .init([Color("ColorWatermelonLight"), Color("ColorWatermelonDark")]),
    description: .init("""
      ...
      """),
    nutritionFacts: [
      .init(.energy, "127 kJ (30 kcal)"),
      .init(.sugar, "6.2 g"),
      .init(.fat, "0.15 g"),
      .init(.protein, "0.61 g"),
      .init(.vitamins, "A, B1, B2, B3, B5, B6, C"),
      .init(.minerals, "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Sodium, Zinc")
    ]
  ),
  Fruit(
    ...
    headline: .init("Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft."),
    image: .init("cherry"),
    gradientColors: .init([Color("ColorCherryLight"), Color("ColorCherryDark")]),
    description: .init("""
      ...
      """),
    nutritionFacts: [
      .init(.energy, "209 kJ (50 kcal)"),
      .init(.sugar, "8.5 g"),
      .init(.fat, "0.3 g"),
      .init(.protein, "1 g"),
      .init(.vitamins, "A, B1, B2, B3, B5, B6, B9, C, K"),
      .init(.minerals, "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Sodium, Zinc")
    ]
  ),
  Fruit(
    title: .init("Grapefruit"),
    headline: .init("Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft."),
    image: .init("grapefruit"),
    gradientColors: .init([Color("ColorGrapefruitLight"), Color("ColorGrapefruitDark")]),
    description: .init("""
      ...
      """),
    nutritionFacts: [
      .init(.energy, "138 kJ (33 kcal)"),
      .init(.sugar, "7.31 g"),
      .init(.fat, "0.10 g"),
      .init(.protein, "0.8 g"),
      .init(.vitamins, "B1, B2, B3, B5, B6, B9, C, E"),
      .init(.minerals, "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Zinc")
    ]
  ),
  Fruit(
    title: .init("Apple"),
    headline: .init("Apples are one of the most popular, and exceptionally healthy fruit, and for good reason."),
    image: .init("apple"),
    gradientColors: .init([Color("ColorAppleLight"), Color("ColorAppleDark")]),
    description: .init("""
